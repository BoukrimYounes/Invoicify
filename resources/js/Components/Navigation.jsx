        ...
        <div className="relative">
          ...
          >
            <div
              ...
              className="h-14 w-14  bg-blue-500 rounded-full flex items-center justify-center shadow-md hover:shadow-lg transition-shadow"
            >
              <span className="text-white text-2xl font-semibold ">{getInitials(user.name)}</span>
            </div>
          </motion.div>
